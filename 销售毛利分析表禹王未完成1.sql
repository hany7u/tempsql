select ial.pk_org,ialb.vsrctype ,
       ial.pk_group,
       ial.cbillid,
       ialb.cbill_bid,
       se.csaleinvoiceid,
       ...
       case when seb.norigmny = 0 then 0 else (seb.nmny - ialb.nmny)/seb.nmny end marginRatio  ,ih.vbillcode,se.vbillcode,ial.dr,ial.vbillcode
